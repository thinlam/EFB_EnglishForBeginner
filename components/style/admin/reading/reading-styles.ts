// components/style/admin/reading/reading-styles.ts
import { StyleSheet } from 'react-native';
import { COLORS } from '../AdminColors';

// Có thể reuse nhiều block từ Listen nhưng bạn tự do chỉnh khác (padding, icon row, v.v.)
export const ReadingStyles = StyleSheet.create({
  ...
  rowLine: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 6 },
  ...
  badgeText: { color: '#0b0f15', fontWeight: '800', fontSize: 12, letterSpacing: 0.3 },

  // Ví dụ Reading khác Listen: thêm spacing cho đoạn văn dài
